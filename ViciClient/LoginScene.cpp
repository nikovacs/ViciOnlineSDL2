...
namespace Scenes {
        ...
        PlayFab::PlayFabClientAPI::LoginWithEmailAddress(request,
            [this](const PlayFab::ClientModels::LoginResult& result, void* customData) {
                ...
                PlayFab::PlayFabClientAPI::GetAccountInfo(request,
                    [this](const PlayFab::ClientModels::GetAccountInfoResult& result, void* customData) {
                        PlayerInfo::username = result.AccountInfo->Username;
                        _parent->_onLoginCallback();
                    }
                );
			},
            [updateError](const PlayFab::PlayFabError& error, void* customData) {
    ...
    void RegisterNowButtonListener::ProcessEvent(Rml::Event& event) {
    ...
    void BackButtonListener::ProcessEvent(Rml::Event& event) {
    ...
    void RegisterButtonListener::ProcessEvent(Rml::Event& event) {
        auto updateError = [&parent = _parent](std::string_view error) {
    ...
    LoginScene::~LoginScene() {
        if (_loginSceneDoc) _loginSceneDoc->Close();
        if (_registerSceneDoc) _registerSceneDoc->Close();
	}
    ...
    void LoginScene::_loginAsGuest(bool goToGameScene) {
        ...
        PlayFab::PlayFabClientAPI::LoginWithCustomID(request,
            [this, goToGameScene](const PlayFab::ClientModels::LoginResult& result, void* customData) {
    ...
    void LoginScene::_addEmailUsernamePassword(std::string_view email, std::string_view username, std::string_view password) {
        ...
        PlayFab::PlayFabClientAPI::AddUsernamePassword(request,
            [this](const PlayFab::ClientModels::AddUsernamePasswordResult& result, void* customData) {
                _unlinkCustomId();
    ...
    void LoginScene::_unlinkCustomId() {
        ...
        PlayFab::PlayFabClientAPI::UnlinkCustomID(request,
            [](const PlayFab::ClientModels::UnlinkCustomIDResult& result, void* customData) {
