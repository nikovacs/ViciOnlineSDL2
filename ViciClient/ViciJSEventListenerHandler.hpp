...
namespace JS {
	...
	public:
		...
		static void addEventListener(const Rml::Element* element, const std::string_view eventType, v8::Global<v8::Function> func);
		static void removeEventListener(const Rml::Element* element, const std::string_view eventType, v8::Global<v8::Function> func);
		static void onElementDeleted(const Rml::Element* element);
